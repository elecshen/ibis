...
{
    public class TestSBlockModPolyTrithemiusEncoder<T>(T alphabet, IAlphabetModifier<T> alphabetModifier) 
        : SBlockModPolyTrithemiusEncoder<T>(alphabet, alphabetModifier) where T : IAlphabet
    {
